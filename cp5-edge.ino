...
#define TOPICO_SUBSCRIBE    "/TEF/hosp7771/cmd"        //tópico MQTT de escuta
#define TOPICO_PUBLISH      "/TEF/hosp7771/attrs"      //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_2    "/TEF/hosp7771/attrs/l"    //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_3    "/TEF/hosp7771/attrs/h"    //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_4    "/TEF/hosp7771/attrs/t"    //tópico MQTT de envio de informações para Broker
                                                      //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                      //            desses tópicos. Caso contrário, há grandes
                                                      //            chances de você controlar e monitorar o ESP32
                                                      //            de outra pessoa.
#define ID_MQTT  "fiware_7771"   //id mqtt (para identificação de sessão)
...
const char* PASSWORD = "Challenge@24!"; // Senha da rede WI-FI que deseja se conectar
 
// MQTT
const char* BROKER_MQTT = "18.208.160.16"; //URL do broker MQTT que se deseja utilizar
